      ...
      <section className="totalContent">
        ...
        <section className="Box">
          <section className="maintext">
            <div>
              <h1>웹툰을 즐겨보시나요?</h1>
              <p>웹툰 그 외 정보를 한 눈에 확인하세요.</p>
            </div>
          </section>
          <aside className="video">
            <img src={require("./image/webtoon.gif").default} alt="광고2"></img>
          </aside>
        </section>
        <section className="Box">
          <aside className="video">
            <img src={require("./image/goods.gif").default} alt="광고2"></img>
          </aside>
          <section className="maintext">
            <div>
              <h1>
                '웹툰샵'과 함께하는 행복하고,<br></br> 즐거운 Webtoon Life
              </h1>
              <p>
                웹툰기반으로 다양한 상품을 구경하시고 관심있는 굿즈를
                찾아보세요.
              </p>
            </div>
          </section>
        ...
        <section className="Box">
          <section className="maintext">
            <div>
              <h1>
                웹툰 원작의 드라마, <br></br>영화에 대해 구경하세요.
              </h1>
              <p>몰랐던 원작 작품들을 알게될지도 모릅니다.</p>
            </div>
          </section>
          <aside className="video">
            <img src={require("./image/drama.gif").default} alt="광고2"></img>
          </aside>
        </section>
      </section>
